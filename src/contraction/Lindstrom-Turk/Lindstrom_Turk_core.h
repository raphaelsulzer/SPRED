...
//
#ifndef LINDSTROM_TURK_CORE_H
#define LINDSTROM_TURK_CORE_H 1
...
#include "LindstromTurk_params.h"
...
public:
  ...
  typedef ECM_    ECM ;
  typedef typename ECM::GeometryTrait Kernel ;
...
#include "Lindstrom_Turk_core_impl.h"

}  // namespace LT

#endif // LINDSTROM_TURK_CORE_H //
// EOF //
