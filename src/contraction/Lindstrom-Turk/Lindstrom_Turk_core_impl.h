...
//
#ifndef LINDSTROM_TURK_CORE_IMPL_H
#define LINDSTROM_TURK_CORE_IMPL_H 1
...
typename LindstromTurkCore<ECM,K>::Optional_point LindstromTurkCore<ECM,K>::compute_placement()
{
  ...
  //
  // Each vertex constrain is an equation of the form: Ai * v = bi
  // Where 'v' is a vector representing the vertex,
  // 'Ai' is a (row) vector and 'bi' a scalar.
  //
  // The vertex is completely determined with 3 such constrains,
  ...
  //
  // The member variable mConstrains contains A and b. Individual constrains (Ai,bi) can be added to it.
...
#endif // LINDSTROMTURK_CORE_IMPL_H //
// EOF //
