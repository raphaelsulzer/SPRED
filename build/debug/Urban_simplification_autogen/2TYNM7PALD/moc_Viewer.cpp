...
QT_MOC_LITERAL(3, 14, 5), // "Point"
QT_MOC_LITERAL(4, 20, 8) // "position"

    },
    "Viewer\0click\0\0Point\0position"
};
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Viewer::*_t)(const Point & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewer::click)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Viewer::click(const Point & _t1)
{
